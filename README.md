...
This module was designed as a wrapper so it could be injected into the pimple. It can also be used othr than that. For example, you can call the class directly and call any function statically to achieve the same result. We suggest you use this through pimple's dependency injector.
